# 1. Khái niệm
Vector là một dạng biểu thị cả độ lớn (magnitude) và hướng (direction) thường được hie, là phần tử thuộc một **không gian vector** - bất kỳ đối tượng nào tuân theo phép Cộng Vector và Nhân với một số (Scalar Multiplication) và thỏa mãn các tiên đề đại số (giao hoán, kết hợp, phân phối, có phần tử trung tính) đều là vector
Trong CNTT và KHMT: 
